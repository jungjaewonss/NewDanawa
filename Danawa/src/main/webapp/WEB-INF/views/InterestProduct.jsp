 ...
 <div id="newvideo" >
    <h3>인기상품</h3>
     <div id="newvideo1">
       ...
       <p style="font-size: 12px; "> <span class="textborder">올해 최고의 best <br />상품 지금아니면 못살걸? <br />구매 가즈아~!!!!</span class="imgborder"></p>
       </div>
    </div>

    <div  class="imgtext">
        <a href=""> <span class="imgborder"><img src="http://placehold.it/200x150" alt=""  class="slide4" ></span ></a>
       <p style="font-size: 12px; "> <span class="textborder">올해 최고의 best <br />상품 지금아니면 못살걸? <br />구매 가즈아~!!!!</span></p>
    </div>
