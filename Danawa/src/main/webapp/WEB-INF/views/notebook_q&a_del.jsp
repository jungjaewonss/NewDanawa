...
<link rel="stylesheet" href="summernote-0.8.18-dist/summernote-lite.css">
  <link rel="stylesheet" href="/resources/css/notebook_q&a_del.css">
...
<body>
	...
	<main role="main" class="container">
		...
		<div id="title_2"
			...
			<h4 id="title" style="margin-top: 30px;">게시물삭제</h4>
		</div>
	...
	<!-- ============================================================================== -->
		<form class="form_1" name="form" method="post"
			action="BoardDelProc.jsp">

			<div class="pt-1"
				style="border: 1px solid gainsboro; width: 100%; height: 70px; display: flex; align-items: center; margin-bottom: 20px;">
				...
				<input type="password" name="password" placeholder="비밀번호입력"
					...
					<input type = "hidden" name = "num" value = "<%=num%>"> <!--삭제하려는게시물의 게시물번호  -->
			</div>
			<input type="hidden" name="inpassword" value=<%=inPassword %>> <!-- 게시물등록할때 설정한 비밀번호  -->
			<input type="hidden" name="inwriter" value=<%=inwriter %>> <!-- 게시물등록할때 설정되어이진 작성이  -->
