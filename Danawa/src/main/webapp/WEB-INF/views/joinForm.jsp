        ...
        <div id="container">
            ...
            <div class="join_notice">
             ...
             <form method="post" action="${root}member/join" onsubmit = "joinFormSubmit(this); return false;">
                ...
                <input type="text" id="memId" name="memId" placeholder="아이디 입력"  onblur="memIdCheck()"/><br/>
                  <div><b id="memIdCheck"></b></div>
            
                <label for="pw">비밀번호</label><br/>
                <input type="password" id="memPassword" name="memPassword" placeholder="숫자, 영문, 특수문자 포함 8자 이상" onblur="checkPassword()"/><br/>
               <b><div id=""></div></b>
                
                
                <label for="pw-check">비밀번호 확인</label><br/>
                <input type="password" id="memPassword1"  placeholder="숫자, 영문, 특수문자 포함 8자 이상" onblur="checkPassword()"/><br/>
              <div><b id="pwdcheckresult"></b></div>
               
                <label for="name">이름</label><br/>
                <input type="text" id="memName" name="memName" placeholder="이름 입력"/><br/>
               
               
                <label for="nickname">닉네임</label><br/>
                <input type="text" id="memNickName" name="memNickName" placeholder="1~ 10자 입력해주세요" onblur="checksubmit()"/><br/>
                 <div><b  id="nicknamecheckresult"></b></div>
